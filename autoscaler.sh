...
if [ $CURRENT_NUMBER_OF_PENDING_JOBS -gt $MAXIMUM_NUMBER_OF_PENDING_JOBS_THRESHOLD ]
    then
...
do
    ...
    if [ $NUMBER_OF_RUNNING_JOBS -eq 0 ] && [ $RUNNER_IDLE_TIME -gt $RUNNER_IDLE_TIME_THRESHOLD ]
    then
